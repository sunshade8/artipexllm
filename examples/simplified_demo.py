...
def get_documents_from_vectorstore(question):
    ...
    try:
        ...
        if os.path.exists(VECTOR_STORE_PATH):
            ...
            print("벡터 스토어를 찾을 수 없습니다. 더미 문서를 사용합니다.")
...
def main():
    ...
    # 첫 번째 질문 실행
    first_question = "색상이 감정에 미치는 영향에 대해 설명해주세요"
    print(f"질문: {first_question}")
    
    # 문서 검색
    print("\n문서 검색 중...")
    documents = get_documents_from_vectorstore(first_question)
    print(f"{len(documents)}개의 관련 문서를 찾았습니다.")
    
    # 답변 생성
    print("\n답변 생성 중...")
    answer = generate_answer(first_question, documents, conversation_history)
    ...
    # 후속 질문
    print("\n=== 후속 질문 ===")
    follow_up = "파란색은 어떤 감정과 연관되나요?"
    print(f"질문: {follow_up}")
    
    # 문서 검색
    print("\n문서 검색 중...")
    documents = get_documents_from_vectorstore(follow_up)
    print(f"{len(documents)}개의 관련 문서를 찾았습니다.")
    
    # 답변 생성
    print("\n답변 생성 중...")
    answer = generate_answer(follow_up, documents, conversation_history)
